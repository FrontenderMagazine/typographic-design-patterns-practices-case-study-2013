...
этого года мы, не жалея времени, собирали новые данные и изучали общие 
изменения и текущие тренды в веб-типографике.
...
исследования 2009 года, шрифты без засечек чаще использовались для
...
Подводя итог, можно утверждать, что примерно на 2/3 проанализированных сайтов в
...
Причиной такого разнообразия используемых шрифтов, наверное, является появление 
и развитие ошибкоустойчивых сервисов вроде Typekit и Fontdeck. В качестве
...
используются тёмные цвета на светлом фоне. В этом плане немногое изменилось,
...
**Подключаемые шрифты** постепенно становятся стандартом в веб-дизайне, однако они
негативно влияют на производительность, так как требуют загрузки файлов шрифтов. Крис Койе
...
Rutter) объяснил, как это сделать, в своём выступлении 
«[Отзывчивые веб-шрифты][22]».
